...
### 1. Indentify a problem worth solving , analyze and visualize.
### 2. Implemented 1 or more ML models using Scikit-Learn 
### 3. Components used: Python data processing, Flask server, Web-based UI (HTML/CSS/Bootstrap), Interactive visualization (Plotly and Tableau) and Heroku deployment


## Topic

### a) How to predict from rating , the 3 different types of cannabis?
### b) How to predict the strain type from effects?
